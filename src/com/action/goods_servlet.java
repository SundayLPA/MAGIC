...
{ 
	...
	public void goodsAdd(HttpServletRequest req,HttpServletResponse res)
	{
		...
		String sql="insert into t_goods(catelog_id,nannvkuan,bianhao,mingcheng,jieshao,pinpai,fujian,shichangjia,tejia,shifoutejia,kucun,del) " +
				   "values(?,?,?,?,?,?,?,?,?,?,?,?)";
		Object[] params={catelog_id,nannvkuan,bianhao,mingcheng,jieshao,pinpai,fujian,shichangjia,tejia,shifoutejia,kucun,del};
		DB mydb=new DB();
