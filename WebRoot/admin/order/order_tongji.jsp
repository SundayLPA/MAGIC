	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/order?type=order_tongji" name="formAdd" method="post">
				     <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
						<tr bgcolor="#E7E7E7">
							<td height="14" colspan="44" background="<%=path %>/img/tbg.gif">&nbsp;销售信息统计&nbsp;</td>
						</tr>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="44" background="<%=path %>/img/tbg.gif">&nbsp;销售信息列表&nbsp;</td>
				</tr>
				...
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="44" align="center" background="<%=path %>/img/tbg.gif">销售额：<font color="red"><%=kk %></font></td>
				</tr>
			</table>
	</body>
</html>
