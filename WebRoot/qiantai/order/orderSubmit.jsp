				...
				<TR>
					...
					<TD class=Side vAlign=top align=right width="75%">
					    <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TR>
									<TD class=head>
										<span style="float:left">Orders Result</span>
									</TD>
								</TR>
								<TR align="left">
									<TD height="5"></TD>
								...
								<TR align="left" height="500">
									<TD>
				                        <table width="99%" border="0" cellpadding="8" cellspacing="8" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								              <tr>
								                  <td align="center" style="color: red">Successful!!!</td>
								              </tr>
								              <tr>
								                  <td>Order Number：${requestScope.order.bianhao }</td>
								              </tr>
								              ...
								              <tr>
								                  <td>Date:${requestScope.order.shijian }</td>
								              </tr>
								              <tr>
								                  <td>Address:${requestScope.order.songhuodizhi }</td>
								              </tr>
								              <tr>
								                  <td>Type of payment:${requestScope.order.fukuanfangshi }</td>
								              </tr>
					        			</table>
									</TD>
								</TR>
