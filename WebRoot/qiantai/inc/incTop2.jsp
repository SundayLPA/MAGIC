...
<html>
  ...
  <body>
       ...
       &nbsp;&nbsp;
       <A href="<%=path %>/qiantai/default.jsp">HOMEPAGE</A> &nbsp;&nbsp;
       <A href="#" onclick="reg()">Register</A> &nbsp;&nbsp;
       <a href="#" onclick="myXinxi()">UserInfo</A> &nbsp;&nbsp;
       <a href="#" onclick="mycart()">YourCart</A> &nbsp;&nbsp;
       <a href="#" onclick="myorder()">Your Account</A> &nbsp;&nbsp;
       
       
	   <input type="text" name="mingcheng" size="30">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="#" onclick="admin()">BACKGROUND</a> &nbsp;&nbsp;
	   </form>
  </body>
</html>
