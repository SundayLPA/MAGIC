				...
				<TR>
					...
					<TD class=Side vAlign=top align=right width="75%">
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TR>
									<TD class=head>
										<SPAN class="TAG">Product Details</SPAN>
									</TD>
								</TR>
								<TR align="left">
									<TD height="5"></TD>
									...
									<TD align="center">
									    <form action="<%=path %>/buy?type=addToCart" method="post" name="buy">
			                                  <table width="100%" border="0" cellpadding="9" cellspacing="9">
												    ...
												    <tr>
												       <td align="left">Product number：${requestScope.goods.bianhao }</td>
												    </tr>
												    <tr>
												       <td align="left">Product Name：${requestScope.goods.mingcheng }</td>
												    </tr>
												    <tr>
												       <td align="left">Describe：<c:out value="${requestScope.goods.jieshao }" escapeXml="false"></c:out></td>
												    </tr>
												    <tr>
												       <td align="left">TradeMark：${requestScope.goods.pinpai }</td>
												    </tr>
												    <tr>
												       <td align="left">Price：${requestScope.goods.shichangjia }</td>
												    </tr>
												    <tr>
												       <td align="left">
												           <hr> 
												             amount：<input type="text" name="quantity" value="1" size="8" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
